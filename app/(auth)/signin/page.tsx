...
export default function SignInPage() {
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
      ...
      {/* Google Sign In Button - will be connected to Convex Auth */}
      <button
        type="button"
      ...
      <form className="space-y-4">
        <div>
          ...
          <input
            ...
            id="email"
            name="email"
            className="mt-1 w-full rounded-lg border border-zinc-300 px-4 py-2 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20 dark:border-zinc-600 dark:bg-zinc-700 dark:text-white"
